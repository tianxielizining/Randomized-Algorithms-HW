...
Use $f_1$ as an input of algorithm $A$.
...
\begin{equation}
   \nonumber  f_2(x)=
    ...
    \end{cases}
\end{equation}
%No matter how algorithm $A$ select input of black box, 
For $f_1(x)$ and $f_2(x)$, algorithm $A$ use the same $n$ points $(x_1,f_1(x_1)),(x_2,f_1(x_2)),...,(x_n,f_1(x_n))$.
