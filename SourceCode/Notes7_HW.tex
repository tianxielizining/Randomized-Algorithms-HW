...
%Then, if the distances between any two points is preserved by $\sqrt{1-\epsilon^{\prime\prime}}$,
%the area of any triangle is preserved by $1-\sqrt{(1-\sqrt{1-\epsilon^{\prime\prime}})^4-16(1-\epsilon^{\prime\prime})}$.
